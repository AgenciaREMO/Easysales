...
class Pdfs extends CI_Controller {
    ...
    public function generar() {
		...
		ob_end_clean(); //Esta Se pone porque sino marca un error en el PDF
...
// Establecemos el contenido para imprimir
       // $provincia = $this->input->post('provincia');
		...
		$enlaces = $this->model_pdfs->getReporte();
       ...
       // $html .= "<h2>Localidades de ".$prov."</h2><h4>Actualmente: ".count($provincias)." localidades</h4>";
        ...
        {
				$id_tp=$fila['id_proyecto'];
				//$N_Personal=$fila['personalnom'];
				
 
            $html .= "<tr><td class='id'>" . $id_tp . "</td><td class='localidad'>" . $N_Personal . "</td></tr>";
        }
        $html .= "</table>";
