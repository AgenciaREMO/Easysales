...
<body>
	...
	switch($_REQUEST['msg']){
		...
		case 3: ?>
			...
			<div class="alert alert-success">¡MENSAJE! Los datos del brief se guardaron correctamente</div>
			<?php
			break;
		case 4: ?>
		
			<div class="alert alert-success">¡MENSAJE! El brief se elimino correctamente</div>
			<?php
			break;
